...
@Component({
  selector: 'app-gauss-total',
  templateUrl: './gauss-total.component.html',
  styleUrls: ['./gauss-total.component.scss']
})
export class GaussTotalComponent implements OnInit {
  ...
  getResults(){
    ...
    this.request.getJson("gaussTotal", {a: this.strMatrixA, b: this.strMatrixB}).subscribe((res: any) => {
      if(res.error){
